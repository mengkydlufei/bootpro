/*var home_Path = document.location.protocol +'//' + window.document.location.origin;*/
...
if(!norunFlag){
	...
	(function (){
		...
		/*	if (window.document.location.origin == home_Path) { //主页URL判断，需要斜杠结尾*/
