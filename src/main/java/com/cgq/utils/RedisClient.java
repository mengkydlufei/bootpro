...
public class RedisClient {
    ...
    public long setObjectList(String key, List<Object> value, int cacheSeconds) {
        ...
        try {
            ...
            result = jedis.rpush(getBytesKey(key), SerialiseUtils.serialize(list));
            if (cacheSeconds != 0) {
                jedis.expire(key, cacheSeconds);
            }
...
//			logger.debug("getResource.", jedis);
     ...
     * @return
     */
    public static byte[] getBytesKey(Object object) throws Exception{
        if(object instanceof String){
            return StringUtil.getBytes((String)object);
        }else{
            return SerialiseUtils.serialize(object);
        }
    }
    ...
    public static Object toObject(byte[] bytes) throws Exception{
        return SerialiseUtils.unserialize(bytes);
    }
